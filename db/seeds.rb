...
Listing.create!(
  ...
  description: 'I have for you to consider this Vampire Hunter/Slayer staked mummified "REAL HEART" (not realy it\'s fake). The vampire heart has a permanent hole in the heart. The heart is made of polymer clay and many layers of paint and waxed sealed; ~ heart, 4.25" long by 2.75" wide.',
  available: true
)
