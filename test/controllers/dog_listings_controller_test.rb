...
class DogListingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dog_listing" do
    assert_difference('DogListing.count') do
      post dog_listings_url, params: { dog_listing: { breed: @dog_listing.breed, name: @dog_listing.name, price: @dog_listing.price, seller_email: @dog_listing.seller_email, weight: @dog_listing.weight } }
    end
  ...
  test "should update dog_listing" do
    patch dog_listing_url(@dog_listing), params: { dog_listing: { breed: @dog_listing.breed, name: @dog_listing.name, price: @dog_listing.price, seller_email: @dog_listing.seller_email, weight: @dog_listing.weight } }
